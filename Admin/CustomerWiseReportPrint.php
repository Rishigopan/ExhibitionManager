        ...
        <div class="container-fluid px-4 main-content">
            <div class="toolbar">
                <div class="card card-body p-2 px-3 text-white text-center">
                    <?php 
                        $find_orderDetails = mysqli_query($con, "SELECT * FROM order_table WHERE order_id = '$OrderId'");
            ...
            <div class="row p-0 py-1 mb-4 mt-3" id="printManfacture">
                ...
                <?php 
                    ...
                    $displayImages = mysqli_query($con, "SELECT * FROM order_items oi INNER JOIN item_master i ON oi.ord_itemId = i.item_id WHERE oi.ord_id = '$OrderId'");
